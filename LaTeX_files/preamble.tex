...
% 1. تعريف المتغير البدائي (يمكنك وضع عنوان مشروعك هنا كقيمة افتراضية)
  \newcommand{\currentfooter}{دفتر مواصفات وشروط فنية لمحول}

  % 2. الأمر السحري السلس لتغيير التذييل في أي مكان وفي أي مشروع مستقبلي
  \newcommand{\setfooter}[1]{\gdef\currentfooter{#1}}
...
\fancypagestyle{mainstyle}{
    ...
    % RO: الصفحات الفردية (رقم الصفحة | المتغير العالمي)
    \fancyfoot[RO]{\fontsize{10}{12}\selectfont \thepage\ \ |\ \ \currentfooter}

    % LE: الصفحات الزوجية (المتغير العالمي | رقم الصفحة)
    \fancyfoot[LE]{\fontsize{10}{12}\selectfont \currentfooter\ \ |\ \ \thepage}
...
% اختر أحد الخيارات التالية حسب دليل تنسيق جامعتك:
\onehalfspacing % لتباعد بمقدار سطر ونصف (1.5) - وهو القياسي والأكثر شيوعاً للمشاريع
% \doublespacing % لتباعد مضاعف (2.0)